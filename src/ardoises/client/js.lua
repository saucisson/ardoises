...
package.preload ["ardoises.jsonhttp.copas"] = function ()
  return require "ardoises.jsonhttp.js"
end
...
--     local Http     = require "ardoises.jsonhttp.js"
...
--       }
--       local ardoise = client:ardoise (Lustache:render ("{{{owner.login}}}/{{{name}}}:{{{branch}}}", parameters.repository))
